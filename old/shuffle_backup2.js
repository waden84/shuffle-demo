...
function printArr (array_in, c_i, r_i) {
        document.write("<p>")

        for (var j=0; j<array_in.length;++j) {
            if (j === r_i) {
                document.write(" <span class='b'> " + array_in[j] + " </span> ")
            }
            else if (j > c_i) {
                document.write(" <span class='g'> " + array_in[j] + " </span> ")
            }
            else if (j === c_i) {
                document.write(" <span class='r'> " + array_in[j] + " </span> ")
            }
            else
...
function shuffle(array_in) {
    printArr(array_in,array_in.length,-1);
